                ...
                try {
                    ...
                    if (referringProfileId) {
                        ...
                        if (referralProcessed) {
                            logger_1.logger.info(`Successfully processed referral for profile ${savedProfile._id} with referral code ${user.referralCode}`);
                        }
                        else {
                            logger_1.logger.warn(`Failed to process referral for profile ${savedProfile._id} with referral code ${user.referralCode}`);
                        }
                    }
                    else {
