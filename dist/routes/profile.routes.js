 ...
 */
router.delete('/duplicates/personal', authMiddleware_1.authenticateToken, (0, roleMiddleware_1.requireRole)(['admin', 'superadmin']), profileController.deleteDuplicatePersonalProfiles.bind(profileController));
