...
const envSchema = z.object({
  ...
  JWT_ACCESS_EXPIRATION: z.string().default("4h"),  // Extended from 1h to 4h for better user experience
  JWT_REFRESH_EXPIRATION: z.string().default("30d"), // For extended sessions
